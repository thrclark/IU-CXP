...
export const routes: Routes = [
  ...
  { path: 'academics/course-catalog', component: PlaceholderPageComponent, data: { title: 'Course Catalog', icon: 'book-open' } },
  { path: 'academics/register-for-classes', component: PlaceholderPageComponent, data: { title: 'Register for Classes', icon: 'pencil' } },
  { path: 'academics/degrees-majors', component: PlaceholderPageComponent, data: { title: 'Degrees & Majors', icon: 'graduation-cap' } },
