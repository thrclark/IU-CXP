...
export const TASK_COLLECTIONS: TaskCollection[] = [
  {
    ...
    description: 'The tasks most new IU employees need in their first weeks — getting into HR and payroll systems, verifying eligibility to work, and securing your account.',
    icon: 'rvt-user',
    serviceSlugs: [
      'hrms',
      'i-9-e-verify-login',
  ...
  },
  {
    ...
    description: 'Everything a new student needs to get set up before classes start: registration, coursework, account security, and your IU account.',
    icon: 'rvt-user',
    serviceSlugs: [
      'one-iu-registration',
      'canvas',
  ...
  },
  {
    ...
    description: 'What matters as the semester wraps up: exam dates and syllabi, course evaluations, and a place to study.',
    icon: 'rvt-calendar',
    serviceSlugs: [
      'academic-calendar',
      'view-syllabi',
